        ...
        <div class="row">
            ...
            <div class="col-md-6 text-end view-none">
                <div class="form-group" style="transform:translateY(70%);">
                    <label for=""><span class="icon-user"></span> Marco Diaz</label>
                </div>
            </div>
        </div>
    </div>
    <div class="container menu-cont">
        <nav class="navbar menu">
            ...
            <div class="container-fluid enlaces">
                <a class="link" href="home"><span class="icon-home"></span> Inicio</a>
                <a class="link" href="recursos"><span class="icon-folder-open"></span> Recursos</a>
                <a class="link" href="recursos"><span class="icon-folder-open"></span> Recursos</a>
                <a class="link" href="recursos"><span class="icon-folder-open"></span> Recursos</a>
                <a class="link" href="nosotros"><span class="icon-users"></span> Nosotros</a>
            </div>
        </nav>
    </div>
</section>