<?php
    ...
    $recursos_ = $admi->lista_docente_l();
    $cursos = $admi->lista_curso();
                ...
                <div class="card rounded-0">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#add"><span class="icon-plus"></span> Registrar nuevo docente</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nombre_d" id="cod_r" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Apellidos:</label>
                                                        <input type="text" name="apellido_d" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="grado" class="form-select">
                                                            ...
                                                            <option value="<?php echo $grade[0];?>"><?php echo $grade[1] ."  -  ".$grade[2] ;?></option>
                                                            <?php }?>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Especialidad del docente:</label>
                                                        <input type="text" name="esp" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Nivel Academico del docente:</label>
