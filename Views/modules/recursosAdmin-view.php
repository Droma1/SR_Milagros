                ...
                <div class="card rounded-0">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#add"><span class="icon-plus"></span> Registrar</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6">
                                                    <div class="form-group" style="display:none;">
                                                        ...
                                                        <input type="text" name="user" value="<?php echo $_SESSION['tipo_user']; ?>" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Codigo del Recurso:</label>
                                                        <input type="text" name="cod_rec" id="cod_r" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Archivo:</label>
                                                        <input type="file" name="archivo" id="PdfInp" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Título:</label>
                                                        <input type="text" name="titulo_r" id="titulo"  class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Grado:</label>
                                                        <select name="grado" class="form-select">
                                                            <?php while ($grade = $name_->fetch()) {?>
                                                            <option value="<?php echo $grade[0];?>"><?php echo $grade[1];?></option>
                                                            <?php }?>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">fecha de publicación:</label>
                                                        <input type="text" name="fecha_p" id="fecha_p" value="<?php echo date('Y-m-d'); ?>" class="form-control" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">fecha de subida:</label>
                                                        <input type="text" name="fecha_s" id="fecha_s" value="<?php echo date('Y-m-d'); ?>" class="form-control" readonly>
                                                    </div>
                                                <br>
                                            </div>
                                            <div class="col-md-6 col-lg-6 col-xl-6">
                                                <iframe id="view_pdf" src="<?php echo URL; ?>scripts/doc/Doc1.pdf" frameborder="0" style="width:100%;height:100%;"></iframe>
                                            </div>
                                            <br>
				  ...
				  <table class="table table-striped">
                    ...
                    <?php $contador = 0; while($datos = $recursos_->fetch()){ $contador++;?>
				      <tr>
				        ...
				        <td><span class="badge bg-info" style="text-shadow:0px 0px 2px #000;"><?php echo $datos[8]; ?></span></td>
